...
class Toys extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: Toys());
  }
}
...
final List<Map<String, dynamic>> exploreMore = [
  ...
  {
    'image': 'assets/images/office_chair_2.png',
    'brand': 'Highlander',
...
final List<Map<String, dynamic>> lowPriceProducts = [
  ...
  {
    'image': 'assets/images/NikeBasketballShoeGreenBlack.png',
    'brand': 'SneakPeak',
...
class Toys1 extends StatelessWidget {
  const Toys1({super.key});
