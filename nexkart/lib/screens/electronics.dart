...
class Electronics extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: Electronics());
  }
}
...
final List<Map<String, dynamic>> exploreMore = [
  {
    'image': 'assets/images/acer_laptop_1.png',
    'brand': 'JACKBELLA',
    'title': 'Acer Laptop',
    'discount': '↓78%',
    'oldPrice': '1,599',
  ...
  {
    'image': 'assets/images/iphone_12_blue.png',
    'brand': 'Highlander',
...
final List<Map<String, dynamic>> lowPriceProducts = [
  ...
  {
    'image': 'assets/images/iphone_12_green.png',
    'brand': 'Highlander',
    'title': 'Slim-Fit Blue Jeans',
    'discount': '↓65%',
    'oldPrice': '1,199',
  ...
  {
    'image': 'assets/images/acer_laptop_var_3.png',
    'brand': 'Dennis Lingo',
...
class Electronics1 extends StatelessWidget {
  const Electronics1({super.key});
