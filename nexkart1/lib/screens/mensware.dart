...
import 'package:nexkart1/screens/productpage1.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, home: Mensware());
  }
}

class Mensware extends StatelessWidget {
  Mensware({super.key});
  ...
  final List<Map<String, dynamic>> exploreMore = [
    ...
    {
      'image': 'assets/images/tracksuit_black.png',
      'title': 'Solid Casual Shirt',
      'discount': '↓70%',
      'oldPrice': '999',
      'newPrice': '299',
    ...
    {
      'image': 'assets/images/tracksuit_blue.png',
      'brand': 'Highlander',
      'title': 'Men Casual Wear',
      'discount': '↓65%',
      'oldPrice': '899',
    ...
    {
      'image': 'assets/images/tshirt_blue_collar.png',
      'brand': 'Dennis Lingo',
      'title': 'Stylish Cotton Shirt',
      'discount': '↓72%',
      'oldPrice': '1499',
    ...
    },
    {
      ...
      'delivery': 'Delivery by Thursday',
      'buttonText': 'Buy now',
      'productPage': ProductPageWithNav1(),
    },
    {
