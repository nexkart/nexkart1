...
class _ToysScreenState extends State<ToysScreen> {
  ...
  // Sample toy products (replace with actual toy data and images)
  ...
  Widget _buildBottomNavigationBar(BuildContext context) {
    return BottomNavigationBar(
      ...
      items: const [
        ...
        BottomNavigationBarItem(icon: Icon(Icons.toys), label: 'Toys'),
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          '${product['name']} ${wasInWishlist ? 'removed from' : 'added to'} wishlist',
                        ),
                      ),
                    );
                  },
